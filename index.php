...
<body>
  <?php include("navbar.php"); ?><br><br>
   <?php include("slider.php"); ?> <br>
    ...
    <div class="row">
      <div class="col-sm-6">
        <img src="img/2.jpg" width="100%" style="border:7px  solid #f6f6f6; border-radius: 10px solid #f6f6f6">
      </div>
      <div class="col-sm-6">
    ...
    <hr style="border-color:orange; width:70%; border:3px solid orange; border-radius:10px;">
       <div class="row">
        <div class="col-md-4">
          ...
          <center><p>Data Scienist/phyton dev</p></center>
        </div>
        <div class="col-md-4">
          <center><img src="img/berg.jpg" class="imgbd"></center>
          <center><h1>Enemchukwu Daniel</h1></center>
          <center><p>Fron End Developer</p></center>
        </div>
        <div class="col-md-4">
          <center><img src="img/berg.jpg" class="imgbd"></center>
